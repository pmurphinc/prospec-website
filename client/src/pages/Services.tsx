...
import { ShieldCheck, Award, ArrowRight, CheckCircle2, ClipboardCheck, Layers, Sparkles, Zap, ShieldAlert } from "lucide-react";
  ...
  const residentialServices = [
    {
      ...
      features: ["Complete structural & foundation review", "Roofing, attic, and insulation inspection", "Electrical panels & wiring safety check", "Plumbing systems & fixture testing"],
    },
    {
      ...
      features: ["Early identification of major defects", "Option to address repairs on your schedule", "Increases buyer confidence and trust", "Smooths out the escrow & closing process"],
    },
    {
      ...
      features: ["Verifies builder quality of work", "Identifies hidden framing or HVAC issues", "Ensures compliance with basic safety standards", "Creates a punch list for the builder to resolve"],
    },
    {
      ...
      features: ["Catch settling and structural shifts", "Verify mechanical system performance", "Document issues for builder warranty claims", "Zero out-of-pocket repair costs for covered items"],
    },
  ];
  ...
  const commercialServices = [
    {
      ...
      desc: "Comprehensive physical due diligence reporting aligned with ASTM E2018 standards. We evaluate the building envelope, structural integrity, mechanical systems, and identify deferred maintenance.",
      who: "Commercial buyers, institutional investors, and lenders requiring rigorous risk mitigation.",
      features: ["Detailed ASTM E2018-compliant reporting", "Immediate repairs & deferred maintenance cost tables", "Life-cycle cost projections for major systems", "HVAC, electrical, plumbing, and roofing analysis"],
      href: "/commercial-property-condition-assessments-sacramento",
    },
    {
      title: "Commercial Building Inspections",
      desc: "A practical, thorough physical inspection of light commercial, retail, or industrial buildings. We assess structural safety, electrical panels, commercial HVAC units, and life-safety systems.",
      who: "Small business owners, local investors, and commercial tenants with triple-net (NNN) leases.",
      features: ["Light commercial, retail, and office spaces", "Detailed structural and envelope evaluation", "Clear, direct, and practical recommendations", "Same-day or rapid digital report delivery"],
    ...
    },
    {
      ...
      features: ["Multi-unit portfolio and apartment buildings", "Unit-by-unit interior condition checklists", "Shared HVAC, boiler, and electrical review", "Deferred maintenance capital planning support"],
    ...
    <Layout>
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed max-w-xl">
              From residential home purchases to institutional commercial acquisitions, ProSpec provides highly detailed physical due diligence. Every inspection is led by Patrick Murphy, a Certified Master Inspector with approximately 20 years of construction and inspection experience.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="flex flex-col gap-4 mb-16 max-w-2xl">
            ...
            <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed">
              Complete physical evaluations of residential properties. We identify structural defects, system failures, and immediate safety hazards, giving you absolute confidence in your purchase.
            </p>
          </div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <span className="font-mono text-xs text-primary font-bold shrink-0">{service.price}</span>
                  </div>
      ...
      <section className="border-b border-border bg-card/5 py-20 md:py-28">
        <div className="container">
          <div className="flex flex-col gap-4 mb-16 max-w-2xl">
            ...
            <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed">
              Professional, ASTM-style commercial physical assessments designed for property investors, brokers, and business owners. We deliver deep risk mitigation and deferred maintenance planning.
            </p>
          </div>
            ...
            {commercialServices.map((service, index) => (
              ...
              >
                ...
                <Link href={service.href}>
                  <Button variant="outline" className="w-full border-border hover:border-white text-white font-mono text-xs tracking-widest uppercase py-3">
        ...
        <div className="container">
          <div className="border border-border/80 bg-card/30 p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row justify-between gap-12 items-center">
            <div className="max-w-xl flex flex-col gap-4">
              ...
              <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed">
                We perform an exhaustive, non-invasive physical evaluation of all major structural, mechanical, and safety components of the property. Our findings are documented in an easy-to-read, modern digital report complete with photos.
              </p>
              <div className="mt-2">
                <a
      ...
      <section className="py-20 text-center max-w-3xl mx-auto flex flex-col gap-6 items-center">
        ...
        <p className="font-sans text-xs md:text-sm text-muted-foreground max-w-md leading-relaxed">
          Book your residential inspection instantly online using our real-time scheduling system, or contact us directly to discuss your commercial property specs.
        </p>
