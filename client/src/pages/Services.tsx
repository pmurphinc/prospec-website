...
export default function Services() {
  const residentialServices = [
    ...
    },
    {
      ...
      desc: "Inspection of manufactured/mobile homes including accessible structure, roof, exterior, interior, plumbing, electrical, HVAC, foundation/support components, site drainage, and visible utility connections based on the agreed scope of work.",
      who: "Owners and buyers of manufactured or mobile homes seeking a clear assessment of visible, accessible systems and support components.",
      features: [
        "Accessible structure and support components",
        "Roof, exterior, and interior condition review",
