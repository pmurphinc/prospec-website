    ...
    <Layout>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              ...
              <p className="font-serif text-lg text-primary italic leading-relaxed">
                "From a young age, I was captivated by the world of home
                construction, largely due to my father's influence as a general
                contractor."
              </p>
        ...
        <div className="container max-w-4xl">
          <div className="flex flex-col gap-8">
            ...
            <div className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed flex flex-col gap-6">
              <p>
                "Through hands-on learning under my father's guidance, I gained
                invaluable experience in various aspects of home inspections,
                repairs, and remodeling. Over the past two decades, I've built
                upon this foundation, working tirelessly to serve countless
                families and create safe, comfortable living spaces. Driven by a
                desire to carry on my father's legacy, I've dedicated myself to
                upholding the highest standards in the field."
              </p>

              <p>
                As a Certified Master Inspector (CMI) with InterNACHI, Patrick
                continues to expand his expertise through ongoing education and
                training. Specializing in structural envelopes, roofing, decks,
                and chimneys, he is uniquely equipped to address a wide range of
                complex challenges and provide accurate physical assessments for
                both residential buyers and commercial real estate investors.
              </p>

              <p>
                "My role as a devoted husband and father of 4 has only deepened
                my understanding of a home's significance. Beyond its financial
                value, a home is a sanctuary where memories are created and
                families grow. With this perspective in mind, I approach each
                inspection as if it were for my own family, ensuring that every
                detail is thoroughly examined and explained to my clients. By
                empowering them with knowledge about their homes, I hope to
                contribute to their happiness and peace of mind."
              </p>
            </div>
            ...
            <div className="border-l-2 border-primary pl-6 py-2 my-4">
              <p className="font-serif text-lg md:text-xl text-white italic leading-relaxed">
                "By empowering clients with physical knowledge about their
                prospective properties, I hope to contribute to their happiness,
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed">
                Not all home inspectors are equal. In California, licensing is
                minimal, which is why choosing a Certified Master Inspector
                (CMI) is critical. CMIs are board-certified, have completed
                thousands of inspections, and adhere to the strictest code of
                ethics and continuing education requirements.
              </p>
              <div className="flex gap-4 items-center opacity-95 mt-2">
                <div className="border border-primary/50 bg-primary/10 px-5 py-4 text-center font-mono text-[10px] tracking-widest uppercase text-white transition-all duration-300">
                  Certified Master Inspector
                </div>
      ...
      <section className="py-20 text-center max-w-3xl mx-auto flex flex-col gap-6 items-center">
        ...
        <p className="font-sans text-xs md:text-sm text-muted-foreground max-w-md leading-relaxed">
          Secure Patrick Murphy for your upcoming residential home purchase or
          commercial due diligence. Book online in minutes.
        </p>
